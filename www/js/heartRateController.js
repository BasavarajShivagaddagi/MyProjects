angular.module('starter.heartRateController',[])
//heart rate controller

//heart rate calendar
.controller('heartRateCalendarCtrl', function($scope,LoaderService,heartRateCalendarDataService){
 ...
 $scope.getDetails = function(month) {
   ...
   stdata =   {
     ...
     heartRateCalendarDataService.heartRateCalendarDataServiceFn(stdata).success(function(response) {
...
//heart rate summary list



.controller('heartSummaryListCtrl', function($scope,heartSummaryListDataService,$rootScope) {
		var d = new Date();
		month = (d.getMonth()+1)
...
var stepsOnGraph = 0;$scope.stepsOnGraphsc = 0;
   ...
   heartSummaryListDataService.heartSummaryListDataServiceFn(stdata).success(function(response) {
...
//heart rate summary days controller

.controller('heartRateSummaryDaysListCtrl', function(heartSummaryListDataService,$scope){
	var d = new Date();
		month = (d.getMonth()+1)
		var year = d.getFullYear();
