angular.module('starter.hoursSleptController',[])
//hours slept contoller --poornima

.controller('hoursSleptSummaryListCtrl', function($scope,hoursSleptSummaryListDataService,$rootScope) {
		var d = new Date();
		month = (d.getMonth()+1)
...
var stepsOnGraph = 0;$scope.stepsOnGraphsc = 0;
   ...
   hoursSleptSummaryListDataService.hoursSleptSummaryListDataServiceFn(stdata).success(function(response) {
...
.controller('hoursSleptSummaryDaysListCtrl', function(hoursSleptSummaryListDataService,$scope){
	var d = new Date();
		month = (d.getMonth()+1)
		var year = d.getFullYear();
...
.controller('sleepCalendarCtrl', function($scope,LoaderService,sleepCalendarDataService){
 ...
 $scope.getDetails = function(month) {
  var mon = month <= 9 ? '0'+month : month;
   ...
   stdata =   {
     ...
     sleepCalendarDataService.sleepCalendarDataServiceFn(stdata).success(function(response) {
