angular.module('starter.waterLogController',[])

//water log controller
.controller('waterLogSummaryListCtrl', function($scope,waterLogSummaryListDataService,$rootScope) {
		var d = new Date();
		month = (d.getMonth()+1)
...
var stepsOnGraph = 0;$scope.stepsOnGraphsc = 0;
   ...
   waterLogSummaryListDataService.waterLogSummaryListDataServiceFn(stdata).success(function(response) {
...
.controller('waterLogSummaryDaysListCtrl', function(waterLogSummaryListDataService,$scope){
	var d = new Date();
		month = (d.getMonth()+1)
		var year = d.getFullYear();
	   	var issueDate = localStorage.getItem('issueDate');
...
.controller('waterCalendarCtrl', function($scope,LoaderService,waterCalendarDataService){
 ...
 $scope.getDetails = function(month) {
  var mon = month <= 9 ? '0'+month : month;
   ...
   stdata =   {
     ...
     waterCalendarDataService.waterCalendarDataServiceFn(stdata).success(function(response) {
