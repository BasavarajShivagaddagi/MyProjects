angular.module('starter.stepsController',[])
.controller('fitBitCalendarCtrl', function($scope,LoaderService,fitBitCalendarDataService){
 ...
 $scope.getDetails = function(month) {
     ...
     fitBitCalendarDataService.fitBitCalendarDataServiceFn(stdata).success(function(response) {
...
.controller('stepsSummaryListCtrl', function($scope,stepsSummaryListDataService,$rootScope) {
		var d = new Date();
		month = (d.getMonth()+1)
...
var stepsOnGraph = 0;$scope.stepsOnGraphsc = 0;
   ...
   stepsSummaryListDataService.stepsSummaryListDataServiceFn(stdata).success(function(response) {
...
.controller('stepsSummaryDaysListCtrl', function(stepsSummaryListDataService,$scope){
                var d = new Date();
                month = (d.getMonth()+1)
                var year = d.getFullYear();
                var issueDate = localStorage.getItem('issueDate');
